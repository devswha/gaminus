...
<p align="center">
  ...
  <a href="https://github.com/devswha/gajae-app-v1/issues">Sorunlar</a>
</p>
...
[GitHub Releases](https://github.com/devswha/gajae-app-v1/releases) içinden değişmez bir `gajae-app-server-<version>-linux-x64-node22.tar.gz` yapıtı kullanın. Desteklenen bir kurulum şunları yapmalıdır:
...
Node.js 22 kullanın ve değişiklikleri göndermeden önce tam geçidi çalıştırın:
...
- [Sorun takipçisi](https://github.com/devswha/gajae-app-v1/issues)
