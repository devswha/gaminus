...
[GitHub Releases](https://github.com/devswha/gajae-app-v1/releases)의 불변 `gajae-app-server-<version>-linux-x64-node22.tar.gz` 아티팩트를 사용하세요. 지원되는 설치는 다음을 충족해야 합니다.
...
Node.js 22를 사용하고 변경 사항을 제출하기 전에 전체 게이트를 실행하세요.
