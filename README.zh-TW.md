...
<p align="center">
  ...
  <a href="https://github.com/devswha/gajae-app-v1/issues">問題</a>
</p>
...
使用來自 [GitHub Releases](https://github.com/devswha/gajae-app-v1/releases) 的不可變 `gajae-app-server-<version>-linux-x64-node22.tar.gz` 成品。受支援的安裝必須：
...
- [貢獻](CONTRIBUTING.md)
- [問題追蹤器](https://github.com/devswha/gajae-app-v1/issues)
