...
<p align="center">
  ...
  <a href="https://github.com/devswha/gajae-app-v1/issues">问题</a>
</p>
...
使用来自 [GitHub Releases](https://github.com/devswha/gajae-app-v1/releases) 的不可变 `gajae-app-server-<version>-linux-x64-node22.tar.gz` 制品。受支持的安装必须：
...
- [贡献](CONTRIBUTING.md)
- [问题跟踪器](https://github.com/devswha/gajae-app-v1/issues)
